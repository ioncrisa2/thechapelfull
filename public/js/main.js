$(function () {
    ...
    $.each($(".owl-slider-video"), function (i, n) {
        var owl = $(n).owlCarousel({
            autoHeight: false,
            items: 1,
            singleItem: true,
            addClassActive: true,
            transitionStyle: "fade",
            afterAction: adjustVideoPlayback,
            stopOnHover: false,
            navigation: true, // Disable navigation arrows if not needed
            pagination: true, // Disable pagination dots if not needed
        });
    
        playActiveVideo();
    
        // Function to play video of the active item and set timer for slide transition
        function playActiveVideo() {
            ...
            if (video) {
                video.play();
                // Pause autoplay and resume after video duration
        ...
        // Function to adjust video playback on slide change
